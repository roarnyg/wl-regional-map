...
<div class="nor-map" itemprop="text">
 <div id="nordNorgeMap" class="main-map">
  <?php include(dirname(__FILE__) . "/nordnorge/nordnorge.svg"); ?>
 </div>
 <div id="finnmarkMap" class="sub-map">
  <span class="bt-back"></span>
  <?php include(dirname(__FILE__) . "/nordnorge/finnmark.svg"); ?>
 </div>
 <div id="tromsMap" class="sub-map">
  <span class="bt-back"></span>
  <?php include(dirname(__FILE__) . "/nordnorge/troms.svg"); ?>
 </div>
 <div id="nordlandMap" class="sub-map">
  <span class="bt-back"></span>
  <?php include(dirname(__FILE__) . "/nordnorge/nordland.svg"); ?>
 </div>
</div>
<?php
return ob_get_clean();
